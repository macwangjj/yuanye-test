...
test("history certification rejects stale or partial metadata", () => {
  ...
  }), false, "records missing the seam detail-loss, upscale-artifact, posterization, compression-artifact, sharpen-halo, richness, layout, mirror-axis, pre-tiled, texture-density, outer-frame, and aspect-warp gates should not be downloadable");
  assert.equal(recordHasCertifiedDownload({
    ...certifiedRecord,
    certification: {
      ...certifiedRecord.certification,
